...
//	}
//
//	double root = newtonRaphson(polynomial, 0.6, 0.0001, 0.0001, 50);
//	std::cout << "Raiz: " << root << std::endl;

	int v[] = { 1, -6, 10, -6, 9 }; //vetor com os valores de b (posição 0 relativa a x^0, 1 a x^1 .......)

	std::cout << newton_pol(v, 2, 0.00001, 1000) << std::endl;
